...
const packageObj = {
  ...
  popup: {
    name: 'package.popup.name',
    routename: ROUTE.PACKAGES_POPUP_BASIC,
    description: 'package.popup.description.basic',
    version: '1.2.0',
    updated: '2022-08-22',
    link: {
      github: 'https://github.com/BlackToolBoxLaboratory/react-popup',
  ...
  facebookSDK: {
    ...
    routename: ROUTE.PACKAGES_LIST_BASIC,
    description: 'application.facebookSDK.description',
    version: '8.0.0',
    updated: '2020-09-05',
    link: {
