  ...
  },
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            title: 'Basic',
            langIndex: 'menu.packages.basic',
            href: redirectUrl(ROUTE.PACKAGES_POPUP_BASIC),
          },
          {
            id: 'PACKAGES_POPUP_EXAMPLE',
            title: 'Example',
            langIndex: 'menu.packages.popup.example',
            href: redirectUrl(ROUTE.PACKAGES_POPUP_EXAMPLE),
          },
        ],
      },
      {
      ...
      },
      {
        ...
        href: redirectUrl(ROUTE.PACKAGES_LOCALSTORAGE),
      },
      {
        id: 'PACKAGES_FOLDER',
        title: 'Folder',
        langIndex: 'menu.packages.folder',
        href: redirectUrl(ROUTE.PACKAGES_FOLDER),
      },
    ],
  },
  {
        ...
        children: [
          {
            ...
            href: redirectUrl(ROUTE.APPLICATIONS_FACEBOOK_SDK_BASIC),
          },
          {
            id: 'APPLICATIONS_FACEBOOK_SDK_API',
            title: 'APIs',
            langIndex: 'menu.application.fbsdk.apis',
            href: redirectUrl(ROUTE.APPLICATIONS_FACEBOOK_SDK_API),
          },
          {
            id: 'APPLICATIONS_FACEBOOK_SDK_COMPONENTS',
            title: 'Components',
            langIndex: 'menu.application.fbsdk.components',
            href: redirectUrl(ROUTE.APPLICATIONS_FACEBOOK_SDK_COMPONENTS),
          },
        ],
      },
      {
