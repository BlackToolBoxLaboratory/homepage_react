    ...
    content.push(
      <div className='wrapper wrapper-basic'>
        ...
        <div className='context'>
          ...
          <div className='content'>
            <span>It has a notice here about many repositories in used. In this page, we have two repositories: exampleFlux and exampleFlux_server. There are two things need to be cautioned:</span>
          </div>
          <div className='content'>
            <BTBList 
              STYLE={{
