...
const ExampleInfo = enhance(() => {
  return (
    <Page className="btb-pkg-table-example-info">
      <PageHead title={lang.translate('package.table.example.info.title')} clickBtn={openLink} linkList={packageInfo.linkList} />
      <Section head={(
        <>
        ...
        <p>
          {lang.translate('package.table.example.info.description')}
        </p>
      </Section>
