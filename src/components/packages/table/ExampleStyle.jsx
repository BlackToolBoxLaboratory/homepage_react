...
const ExampleStyle = enhance(() => {
  return (
    <Page className="btb-pkg-table-example-style">
      <PageHead title={lang.translate('package.table.example.style.title')} clickBtn={openLink} linkList={packageInfo.linkList} />
      <Section head={(
        <>
        ...
        <p>
          {lang.translate('package.table.example.style.description')}
        </p>
      </Section>
