...
const ExampleSlot = enhance(() => {
  return (
    <Page className="btb-pkg-button-example-style">
      <PageHead title={lang.translate('package.button.example.style.title')} clickBtn={openLink} linkList={packageInfo.linkList}/>
      <Section head={(
        <>
